<x-guest-layout>
    <div class="min-h-screen flex flex-col justify-center items-center bg-gray-50 dark:bg-gray-900" style="padding: 10px">
        <div class="w-full max-w-md p-8" style="padding: 10px">
            <!-- Logo -->
                    ...
                    <g id="Group_48" data-name="Group 48" transform="translate(-578.375 -6374.341)">
                        <g id="Group_35" data-name="Group 35" transform="translate(672.722 6385.679)">
                            <g id="Group_33" data-name="Group 33" transform="translate(0 0)">
                                <path id="Path_19" data-name="Path 19" d="M921.12,6432.523a9.04,9.04,0,1,1,9.04-9.04h-2.583a6.457,6.457,0,1,0-6.457,6.457Z" transform="translate(-912.08 -6414.444)" fill="#00a9f3"></path>
                            </g>
                            <g id="Group_34" data-name="Group 34" transform="translate(9.04 0)">
                                <path id="Path_20" data-name="Path 20" d="M953.094,6432.523a9.05,9.05,0,0,1-9.04-9.04h2.583a6.457,6.457,0,1,0,6.457-6.457v-2.583a9.04,9.04,0,0,1,0,18.08Z" transform="translate(-944.054 -6414.444)" fill="#00a9f3"></path>
                            </g>
                        </g>
                        <g id="Group_43" data-name="Group 43" transform="translate(710.5 6380.22)">
                            <g id="Group_36" data-name="Group 36" transform="translate(0 5.458)">
                                <path id="Path_21" data-name="Path 21" d="M1054.743,6432.52a9.041,9.041,0,1,1,9.04-9.041A9.051,9.051,0,0,1,1054.743,6432.52Zm0-15.5a6.458,6.458,0,1,0,6.458,6.458A6.465,6.465,0,0,0,1054.743,6417.021Z" transform="translate(-1045.703 -6414.438)" fill="#2a2a69"></path>
                            </g>
                            <g id="Group_37" data-name="Group 37" transform="translate(38.728 5.458)">
                                <path id="Path_22" data-name="Path 22" d="M1191.723,6432.52a9.041,9.041,0,1,1,9.04-9.041A9.051,9.051,0,0,1,1191.723,6432.52Zm0-15.5a6.458,6.458,0,1,0,6.457,6.458A6.465,6.465,0,0,0,1191.723,6417.021Z" transform="translate(-1182.683 -6414.438)" fill="#2a2a69"></path>
                            </g>
                            <g id="Group_38" data-name="Group 38" transform="translate(59.52 5.458)">
                                <path id="Path_23" data-name="Path 23" d="M1265.267,6432.52a9.041,9.041,0,1,1,9.04-9.041A9.051,9.051,0,0,1,1265.267,6432.52Zm0-15.5a6.458,6.458,0,1,0,6.457,6.458A6.465,6.465,0,0,0,1265.267,6417.021Z" transform="translate(-1256.227 -6414.438)" fill="#2a2a69"></path>
                            </g>
                            <g id="Group_39" data-name="Group 39" transform="translate(81.081 0)">
                                <rect id="Rectangle_7" data-name="Rectangle 7" width="2.583" height="23.152" fill="#2a2a69"></rect>
                            </g>
                            <g id="Group_42" data-name="Group 42" transform="translate(20.084 5.202)">
                                <g id="Group_41" data-name="Group 41">
                                    <g id="Group_40" data-name="Group 40">
                                        <path id="Path_24" data-name="Path 24" d="M1132.885,6426.7v.031a4.825,4.825,0,0,1-2.8,4.31,10.6,10.6,0,0,1-4.9,1.088,12.779,12.779,0,0,1-8.452-3.041l1.287-2.136c3.031,2.774,7.969,3.458,10.733,1.979a2.831,2.831,0,0,0,1.494-2.19c-.052-1.6-2.04-2.162-5.392-2.776-3.286-.605-7.376-1.36-7.426-5.187a4.631,4.631,0,0,1,2.413-4.04c3-1.81,8.8-1.729,12.683,1.264l-1.288,2.132c-3.086-2.337-7.744-2.763-10.1-1.342a2.429,2.429,0,0,0-1.2,1.967c.02,1.5,2.155,2.058,5.283,2.633C1128.777,6422.048,1132.808,6422.789,1132.885,6426.7Z" transform="translate(-1116.742 -6413.535)" fill="#2a2a69"></path>
                                    </g>
                                </g>
                            </g>
                        </g>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="email" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-white"
                ...
                <div class="mb-4 relative">
                    ...
                    <x-text-input id="password" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-white"
                                  type="password" name="password" required autocomplete="current-password" />
                    <span toggle="#password" class="absolute top-10 right-3 cursor-pointer text-gray-400 dark:text-gray-500">
