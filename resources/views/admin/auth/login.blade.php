<x-guest-layout>
    <div class="min-h-screen flex flex-col justify-center items-center bg-gray-50 dark:bg-gray-900" style="padding: 10px">
        <div class="w-full max-w-md p-8" style="padding: 10px">
            ...
            <div style="text-align: center;font-size: 20px;font-weight: bold;color: lightblue">Admin Panel</div>
            ...
            <form method="POST" action="{{ route('admin.login') }}">
                ...
                <!-- Email -->
                <div class="mb-4">
                    <x-input-label for="email" :value="__('Admin Email')" class="text-gray-700 dark:text-gray-300" />
                    <x-text-input id="email"
                                  class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700
                               focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-white"
